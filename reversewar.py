...
root = Tk()
root.title('Deck')
root.iconbitmap('C:\gui\core.ico')
...
def shuffle():
	...
	global dealer_image
	dealer_image = resize_cards(f'C:/gui/core.ico/cards/{dealer_card}.png')
	...
	# Output Card To Screen
	global player_image
	player_image = resize_cards(f'C:/gui/core.ico/cards/{player_card}.png')
...
# Create Score Label
score_label = Label(root, text="", font=("Helvetica", 14), bg="orange")
